...
var App = (function (_super) {
    ...
    App.prototype.render = function () {
        ...
        return (React.createElement("div", null, React.createElement("h3", null, "Source Code"), React.createElement(component_editor_1.Editor, {"sources": this.state.sources, "schedulers": this.state.schedulers, "onSchedulerChange": function (index) { return _this.onSchedulerChange(index); }}), React.createElement("h3", null, "Garbage Collector Parameters"), React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", null, React.createElement("label", null, "Floating Garbage Percentage")), React.createElement("td", null, React.createElement("input", {"type": "range", "min": "0", "max": "100", "value": floatingGarbagePercentage.toString(), "onChange": function (event) { return _this.onFloatingGarbageChange(event); }})), React.createElement("td", null, floatingGarbagePercentage, "%")), React.createElement("tr", null, React.createElement("td", null, React.createElement("label", null, "Garbage Collection Speed")), React.createElement("td", null, React.createElement("input", {"type": "range", "min": "102400", "max": "10485760", "value": this.state.gcSpeed.toString(), "onChange": function (event) { return _this.onGcSpeedChange(event); }})), React.createElement("td", null, Math.round(this.state.gcSpeed / 1024 / 1024 * 10) / 10, " MB/ms")))), React.createElement("h3", null, "Results"), React.createElement("div", null, this.state.sources.map(function (source, index) {

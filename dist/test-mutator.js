...
describe("Mutator Tests", function () {
    it("should create", function () {
        var simple = Mutator.create(6, [1, 2, 3, 0, 0, 1], [0, 0, 0, 1, 2, 3]);
    ...
    it("should repeat", function () {
        var simple = Mutator.create(6, [1, 2, 3, 0, 0, 1], [0, 0, 0, 1, 2, 3]);
        var repeated = Mutator.repeat(10, simple);
    ...
    it("should shift", function () {
        var simple = Mutator.create(6, [1, 2, 3, 0, 0, 1], [0, 0, 0, 1, 2, 3]);
        var repeated = Mutator.shift(1, simple);
        expect(repeated.bornBetween(0, 0)).to.equals(0);
    ...
    it("should scale", function () {
        var simple = Mutator.create(6, [1, 2, 3, 0, 0, 1], [0, 0, 0, 1, 2, 3]);
        var repeated = Mutator.scale(2, simple);
        expect(repeated.bornBetween(0, 0)).to.equals(0);
    ...
    it("should add", function () {
        var simple = Mutator.create(6, [1, 2, 3, 0, 0, 1], [0, 0, 0, 1, 2, 3]);
        var added = Mutator.add(simple, simple);
